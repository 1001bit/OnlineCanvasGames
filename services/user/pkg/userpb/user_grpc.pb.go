...
type UserServiceClient interface {
	...
	RegisterUser(ctx context.Context, in *UserInputRequest, opts ...grpc.CallOption) (*UserResponse, error)
	LoginUser(ctx context.Context, in *UserInputRequest, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userServiceClient) RegisterUser(ctx context.Context, in *UserInputRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
...
func (c *userServiceClient) LoginUser(ctx context.Context, in *UserInputRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
...
type UserServiceServer interface {
	...
	RegisterUser(context.Context, *UserInputRequest) (*UserResponse, error)
	LoginUser(context.Context, *UserInputRequest) (*UserResponse, error)
...
func _UserService_LoginUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).LoginUser(ctx, req.(*UserInputRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/userpb/user.proto",
}
